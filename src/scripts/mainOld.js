...
const initalizeGame = () => {
  ...
  const tiles = gameField.querySelectorAll(".tile");
...
// const moveTile = (tile, row, col) => {
//   tile.style.setProperty("--x", col);
//   tile.style.setProperty("--y", row);
// };

// const mergeTiles = (tile1, tile2) => {
//   const newValue = parseInt(tile1.textContent) * 2;

//   tile1.textContent = newValue;
//   tile1.classList.remove(`tile--${parseInt(tile1.textContent / 2)}`);
//   tile1.classList.add(`tile--${newValue}`);
//   tile2.remove();
//   score += newValue;
// };
